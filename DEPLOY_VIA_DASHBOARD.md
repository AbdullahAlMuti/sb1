# Deploy via Supabase Dashboard (No CLI Required)

## Problem
You don't have CLI deployment permissions for this project.

## Solution: Deploy via Web Dashboard

### Step 1: Open Supabase Dashboard
Go to: https://supabase.com/dashboard/project/ojxzssooylmydystjvdo/functions

### Step 2: Create New Function
1. Click **"Deploy new function"** or **"Create function"**
2. Function name: `google_sheets_sync`
3. Click **"Create function"**

### Step 3: Copy the Function Code
The code is in: `supabase/functions/google_sheets_sync/index.ts`

Or copy this complete code:
...
- **Verify JWT**: Set to `false` (or leave unchecked)
- Click **"Deploy"**

### Step 5: Verify Deployment
1. Wait for deployment to complete
2. You should see the function listed in your Functions page
...
## Alternative: Request Access

If you can't access the dashboard either, you need to:
1. Contact the project owner
2. Request **Owner** or **Admin** role
3. They can add you at: https://supabase.com/dashboard/project/ojxzssooylmydystjvdo/settings/general

## Troubleshooting

**Can't access dashboard?**
- You might not have any access to this project
- Contact the project owner to be added

**Function already exists?**
- Edit the existing function instead
