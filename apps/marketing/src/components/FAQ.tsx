...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="scroll-mt-24 border-b border-border bg-card py-20 sm:py-24">
      <div className="container px-4">
        ...
        <Reveal className="mx-auto max-w-3xl rounded-lg border border-border bg-background px-6 shadow-sm">
          <Accordion
            type="single"
            collapsible
