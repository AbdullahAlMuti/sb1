...
import { ChevronLeft, Tags, PackageCheck } from "lucide-react";
import { Button } from "@repo/ui/components/ui/button";
import { MustSellAdminTable, ProfitableAdminTable } from "@repo/ui/features/ebay-content-library";

export type ContentView = 'must-sell' | 'profitable-products' | null;
...
export default function ContentLibraryTab({ contentView, setContentView }: ContentLibraryTabProps) {
  if (contentView) {
    ...
    if (contentView === "must-sell") {
      ActiveComponent = MustSellAdminTable;
      ...
      ActiveComponent = ProfitableAdminTable;
