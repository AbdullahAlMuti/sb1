...
/**
 * Canonical status → color mapping for the whole admin app.
 * active/healthy/completed → green · warning → amber · error/failed/critical →
 * red · pending/progress → blue · unknown → slate.
 */
...
export function StatusBadge({ value, className }: { value: string; className?: string }) {
  ...
  const normalized = key.includes("reconnect")
    ? "reconnect"
