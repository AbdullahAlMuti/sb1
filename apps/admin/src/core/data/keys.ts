...
export const keys = {
  ...
  catalogSuppliers: entity("product_suppliers"),
  catalogCategories: entity("product_categories"),
  catalogRecommendations: entity("must_sell_recommendations"),
  catalogSettings: entity("product_smart_settings"),
  catalogAnalytics: entity("catalog_analytics"),
  catalogAutomationLogs: entity("product_automation_logs"),
