    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-display font-bold text-foreground">Plan Features</h1>
            <p className="text-muted-foreground mt-1">{planName} — feature rows shown on pricing page</p>
          </div>
        </div>
        <Button onClick={openCreate}><Plus className="h-4 w-4 mr-2" />Add Feature</Button>
      </motion.div>
